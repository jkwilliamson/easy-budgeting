    ...
    <nav className="navbar navbar-expand-lg bg-body-tertiary">
      <div className="container-fluid">
        <div className='navbar-brand me-2'>
          <img className='d-inline-block pe-1' height='40' padding-right='5' src='/favicon.svg'/>
          Easy Budgeting
        </div>
        <ul className="navbar-nav ms-1 me-auto mb-2 mb-lg-0">
          <li className="nav-item ms-1">
            <a className="nav-link" href="https://www.github.com/jkwilliamson" target="_blank" rel="noopener noreferrer">GitHub</a>
          </li>
          <li className="nav-item ms-1">
            <a className="nav-link" href="https://www.linkedin.com/in/williajk/" target="_blank" rel="noopener noreferrer">LinkedIn</a>
          </li>
        </ul>
      </div>
    </nav>
